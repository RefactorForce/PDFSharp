...
namespace PDFSharp.SharpZipLib.Zip.Compression.Streams
{
    ...
    internal class DeflaterOutputStream : Stream
    {
        ...
        {
            get => password;
            set => password = value != null && value.Length == 0 ? null : value;
        }
        ...
        /// <exception cref="NotSupportedException">Any access</exception>
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int count, AsyncCallback callback, object state) => throw new NotSupportedException("DeflaterOutputStream BeginRead not currently supported");
#endif
		...
		/// <exception cref="NotSupportedException">Any access</exception>
		public override IAsyncResult BeginWrite(byte[] buffer, int offset, int count, AsyncCallback callback, object state) => throw new NotSupportedException("BeginWrite is not supported");
#endif
