...
namespace PDFSharp.SharpZipLib.Zip
{
    ...
    internal sealed class ZipConstants
    {
        ...
        /// </returns>
        public static string ConvertToString(byte[] data, int count) => data == null ? String.Empty : Encoding.GetEncoding(DefaultCodePage).GetString(data, 0, count);
        ...
        /// </returns>
        public static string ConvertToString(byte[] data) => data == null ? String.Empty : ConvertToString(data, data.Length);
        ...
        /// <paramref name="data">data</paramref>converted to a string
        /// </returns>
        public static string ConvertToStringExt(int flags, byte[] data, int count) => data == null
                ? String.Empty
                : (flags & (int)GeneralBitFlags.UnicodeText) != 0 ? Encoding.UTF8.GetString(data, 0, count) : ConvertToString(data, count);
        ...
        /// <paramref name="data">data</paramref>converted to a string
        /// </returns>
        public static string ConvertToStringExt(int flags, byte[] data) => data == null
                ? String.Empty
        ...
        public static byte[] ConvertToArray(string str) => str == null ? (new byte[0]) : Encoding.GetEncoding(DefaultCodePage).GetBytes(str);
#if SILVERLIGHT || NETFX_CORE
#else
#endif
        ...
        /// </param>
        /// <returns>Converted array</returns>
        public static byte[] ConvertToArray(int flags, string str) => str == null
                ? (new byte[0])
                : (flags & (int)GeneralBitFlags.UnicodeText) != 0 ? Encoding.UTF8.GetBytes(str) : ConvertToArray(str);
